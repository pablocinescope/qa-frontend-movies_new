...
import { SignInRequest, User } from "../api/types";
...
function AuthProvider({ children }: AuthProviderProps) {
  ...
  const { mutateAsync: authLogin } = useMutation({
    ...
    mutationFn: (credentials: SignInRequest) => AuthService.login({ params: credentials })
  });
  ...
  const { mutateAsync: refreshTokensRequest } = useMutation({
